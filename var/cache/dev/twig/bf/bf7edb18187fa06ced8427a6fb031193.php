...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/mailer.html.twig", "/home/ticktickelvis/facebook/accueil/accuiel/vendor/symfony/web-profiler-bundle/Resources/views/Collector/mailer.html.twig");
    }
}
